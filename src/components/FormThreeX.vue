...
import { formX, toComposed  } from '@/lib/threeX.js';
// FormThreeX is 三字现
defineOptions({
  name: "FormThreeX"
});
const emit = defineEmits(['submitData'])
const formThreeX = ref();
...
<template>
  <form ref="formThreeX" class="form-quick-choose">
    <table class="t-1">
      <tbody>
        <tr class="bg2">
        ...
        <tr class="match-input">
          <td colspan="4" class="tc">
            <div class="flex-inline gap4">
              ...
              <InputNum v-model="formObj.pei3" type="text" class="w90" boxnumber="3" name="pei3" digits="true" maxlength="10"></InputNum>
            </div>
          </td>
        </tr>
        <tr>
          <td colspan="4" class="remain-match-filter-item">
            ...
            <label><input v-model="formObj.budingheCheckThree" type="checkbox" class="remain-match-filter-three checkbox" remainmatchfilterthree="3"> 三数合</label>
            <InputNum v-model="formObj.budingheThree" type="text" class="w90" name="budinghe" digits="true" maxlength="10"></InputNum>
            </div>
          </td>
        </tr>
        <tr>
          <td colspan="4">
            ...
            三字现<strong class="red2">含</strong>
            <InputNum v-model="formObj.containVal" type="text" class="contain-filter-item w80" name="han" digits="true" maxlength="10"></InputNum>
            三字现<strong class="red2">复式</strong>
            <InputNum v-model="formObj.multiVal" type="text" class="multiple-filter-item" name="fushi" digits="true" maxlength="10"></InputNum>
          </td>
        </tr>
        <tr>
          <td colspan="4">
            <SwitchGroup v-model="formObj.doubleGroup"></SwitchGroup> (<strong class="red2">双重</strong>)
            <SwitchGroup v-model="formObj.doubleThreeGroup"></SwitchGroup> (<strong class="red2">三重</strong>)
          </td>
        </tr>
        <tr>
          <td colspan="4">
            <SwitchGroup v-model="formObj.brotherGroup"></SwitchGroup> (<strong class="red2">二兄弟</strong>)
            <SwitchGroup v-model="formObj.brotherThreeGroup"></SwitchGroup> (<strong class="red2">三兄弟</strong>)
          </td>
        </tr>
        <tr>
        ...
        <tr>
          <td colspan="2" style="width: 50%">
            <SwitchThreeComb v-model:group="formObj.oddGroup" v-model:check="formObj.oddCheckStr" title="单"></SwitchThreeComb>
          </td>
          <td colspan="2" style="width: 50%">
            <SwitchThreeComb v-model:group="formObj.evenGroup" v-model:check="formObj.evenCheckStr" title="双"></SwitchThreeComb>
          </td>
        </tr>
        <tr>
          <td colspan="2" style="width: 50%">
            <SwitchThreeComb v-model:group="formObj.bigGroup" v-model:check="formObj.bigCheckStr" title="大"></SwitchThreeComb>
          </td>
          <td colspan="2" style="width: 50%">
            <SwitchThreeComb v-model:group="formObj.smallGroup" v-model:check="formObj.smallCheckStr" title="小"></SwitchThreeComb>
          </td>
        </tr>
      </tbody>
    </table>
