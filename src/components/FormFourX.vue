      ...
      <tbody>
        ...
        <tr>
          <td colspan="4">
            ...
            <SwitchGroup v-model="formObj.doubleFourGroup"></SwitchGroup> (<strong class="red2">四重</strong>)
          </td>
        </tr>
        <tr>
          <td colspan="4">
            ...
            <SwitchGroup v-model="formObj.brotherFourGroup"></SwitchGroup> (<strong class="red2">四兄弟</strong>)
          </td>
        </tr>
        <tr>
